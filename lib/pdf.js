    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          ...
          {/* Bank information */}
          {(company.bankAccount || company.cci) && (
            <View style={{ marginTop: 15, paddingTop: 15, borderTopWidth: 1, borderTopColor: '#e0e0e0' }}>
              <Text style={[styles.footerLabel, { marginBottom: 5 }]}>Datos Bancarios:</Text>
              {company.bankAccount && (
                <View style={styles.infoRow}>
                  <Text style={styles.footerText}>• {company.bankAccount}</Text>
                </View>
              )}
              {company.cci && (
                <View style={styles.infoRow}>
                  <Text style={styles.footerText}>• CCI: {company.cci}</Text>
                </View>
              )}
            </View>
          )}
